...
import userPic from "../../assets/images/avtar.png";
                                ...
                                <div>
                                    <div className="directory-bg text-center">
                                        <div className="directory-overlay">
                                            <img className="rounded-circle avatar-lg img-thumbnail" src={userPic} alt="Generic placeholder"/>
                                        </div>
                                    </div>

                                    <div className="directory-content text-center p-4">
                                        <p className=" mt-4">{user.email}</p>
                                        <h5 className="font-size-16">{user.fname + " " + user.lname}</h5>
